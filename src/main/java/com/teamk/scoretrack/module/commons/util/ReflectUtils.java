...
/**
 * Just a handy old class I found in one of my old projects
...
public final class ReflectUtils {
    ...
    public static<T> boolean hasAnyNullFields(T o) {
        if (o == null) {
            return true;
        }
        return getAllFields(new ArrayList<>(), o.getClass()).stream().anyMatch(f -> {

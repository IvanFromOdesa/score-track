...
import com.teamk.scoretrack.module.security.track.service.AuthenticationTrackingDataService;
...
public class AuthSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    private final AuthenticationTrackingDataService authenticationTrackingDataService;
    ...
    @Autowired
    public AuthSuccessHandler(AuthenticationTrackingDataService authenticationTrackingDataService,
        ...
        this.authenticationTrackingDataService = authenticationTrackingDataService;
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws ServletException, IOException {
        authenticationHolderService.getCurrentAuthentication().ifPresent(a -> {
            ...
            authenticationTrackingDataService.update(a, track);
        });

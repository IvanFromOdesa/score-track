...
@Service
public class PlayerDataLeaderboardEntityDtoConvertService extends DtoEntityConvertService<PlayerDataLeaderboardProjection, APINbaPlayerLeaderboardDto> {
    public PlayerDataLeaderboardEntityDtoConvertService(MappingContext<PlayerDataLeaderboardProjection, APINbaPlayerLeaderboardDto> mappingContext) {

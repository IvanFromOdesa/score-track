package com.teamk.scoretrack.module.core.api.nbaapi.dao.config;
...
public class APINbaDaoConfig {
    ...
    public MongoClient mongoClient(@Qualifier(PROPS) MongoProperties mongoProperties) {
        ...
        return MongoClients.create(MongoClientSettings.builder().applyToClusterSettings(builder -> builder.hosts(Collections.singletonList(new ServerAddress(mongoProperties.getHost(), mongoProperties.getPort())))).credential(credential).build());
    }

...
function getOnFulfilled() {
    return function (response: AxiosResponse<any, any>) {
        return response;
    };
}
...
axios.interceptors.response.use(getOnFulfilled(), getOnRejected());
baseAxios.interceptors.response.use(getOnFulfilled(), getOnRejected());
